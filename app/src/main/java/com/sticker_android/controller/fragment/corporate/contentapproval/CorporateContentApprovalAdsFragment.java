...
public class CorporateContentApprovalAdsFragment extends BaseFragment implements DesignerActionListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //getContentForApprovalApi();
        return view;
    }

    private void getContentForApprovalApi() {
