 ...
 */
public class CorporateContestAdsFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, PaginationAdapterCallback,CorporateContestAdapter.OnProductItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_corporate_contest_ads, container, false);
        init();
        getuserInfo();
