 ...
 */
public class CorporateContestWonFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public CorporateContestWonFragment() {
    ...
    protected void setViewReferences(View view) {
        recOngoingContestCorp = (RecyclerView) view.findViewById(R.id.recWonContestCorp);
