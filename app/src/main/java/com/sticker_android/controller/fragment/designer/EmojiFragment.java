...
public class EmojiFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private final String TAG = EmojiFragment.class.getSimpleName();
    ...
    public void addNewEmoji(Product emoji){
        ...
        if(emoji != null){
            ...
            mEmojiList.add(0, emoji);
            mAdapter.updateAdapterData(mEmojiList);
