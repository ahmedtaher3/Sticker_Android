...
public class FanDownloadGifFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        ...
        FanDownloadFragment parentFrag = ((FanDownloadFragment) FanDownloadGifFragment.this.getParentFragment());
        if(parentFrag!=null)
