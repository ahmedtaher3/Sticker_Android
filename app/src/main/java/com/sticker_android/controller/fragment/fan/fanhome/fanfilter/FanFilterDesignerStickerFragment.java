 ...
 */
public class FanFilterDesignerStickerFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static FanFilterDesignerStickerFragment newInstance(String param1) {
        FanFilterDesignerStickerFragment fragment = new FanFilterDesignerStickerFragment();
    ...
    public void onRefresh() {
        ...
        FanHomeFragment parentFrag = ((FanHomeFragment) FanFilterDesignerStickerFragment.this.getParentFragment());
        if (parentFrag != null)
    ...
    private void getDesignFromServer(final boolean isRefreshing, final String searchKeyword) {
        ...
        {
            Call<ApiResponse> apiResponseCall = RestClient.getService().apiFilterListCorporateAndDesigner(mLoggedUser.getLanguageId(), mLoggedUser.getAuthrizedKey(),
...
*/
            ...
            Call<ApiResponse> apiResponseCall = RestClient.getService().apiFilterListCorporateAndDesigner_new(mLoggedUser.getLanguageId(),
                    0, 1000000, "", "filter_list", mParam1);
