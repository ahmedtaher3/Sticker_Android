...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // traditionally used with GCM. NotificationApp messages are only received here in onMessageReceived when the app
        ...
        Log.d(TAG, "From: Inside onNewMsg"+remoteMessage.getData().toString() );
