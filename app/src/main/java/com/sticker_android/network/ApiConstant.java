...
//   public static final String IMAGE_URl = "http://18.188.13.98/web/";
    ...
    public static final String API_PROFILE = "myCompanyDetailUpdate/";

    public static final String API_PROFILE_IMAGE = "uploadImage/";
    public static final String API_CHANGE_LANGUAGE = "updateUserLanguage/";
