...
public class AWSUtil {
    ...
    private CognitoCachingCredentialsProvider getCredProvider(Context context) {
        if (sCredProvider == null) {
            sCredProvider = new CognitoCachingCredentialsProvider(
                    ...
                    AppConstant.COGNITO_POOL_ID,
                    Regions.fromName(AppConstant.COGNITO_POOL_REGION));
        }
    ...
    public AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            ...
            sS3Client.setRegion(Region.getRegion(Regions.fromName(AppConstant.BUCKET_REGION)));
        }
        return sS3Client;
    }
    ...
    public TransferUtility getTransferUtility(Context context) {
        if (sTransferUtility == null) {
            sTransferUtility = TransferUtility.builder()
                    ...
                    .defaultBucket(AppConstant.BUCKET_NAME)
                    .build();
        }
