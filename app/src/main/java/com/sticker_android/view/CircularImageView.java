...
public class CircularImageView extends ImageView {
    ...
    public CircularImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = a.getDimensionPixelSize(R.styleable.CircularImageView_civ_app_border_width, 0);
        this.mBorderColor = a.getColor(R.styleable.CircularImageView_civ_app_border_color, DEFAULT_BORDER_COLOR);
        this.mBorderOverlay = a.getBoolean(R.styleable.CircularImageView_civ_app_border_overlay, DEFAULT_BORDER_OVERLAY);
        this.mFillColor = a.getColor(R.styleable.CircularImageView_civ_app_fill_color, 0);
        a.recycle();
        init();
    }
